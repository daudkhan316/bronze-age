...
export const AI_PARAMS: Record<Difficulty, AiParams> = {
  ...
  medium: { thinkInterval: 20, villagerTarget: 10, armyThreshold: 7, buildArcheryRange: true, maxMilitaryPerType: 10 },
  hard: { thinkInterval: 12, villagerTarget: 12, armyThreshold: 7, buildArcheryRange: true, maxMilitaryPerType: 16 },
};
